...
server/images:
         ...
         --image-max-height N     image maximum height, in pixel space, must be larger than 128 (default: 2304)
         --image-max-width N      image maximum width, in pixel space, must be larger than 128 (default: 2304)
